...
namespace Utilities
{
    ...
    SheetSprite::SheetSprite(unsigned int texture_id, float u, float v, float width, float height, float size) : texture_id(texture_id), u(u), v(v), width(width), height(height), size(size) {}
